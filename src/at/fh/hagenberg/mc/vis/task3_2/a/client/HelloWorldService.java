 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://a.task3_2.vis.mc.hagenberg.fh.at/", wsdlLocation = "http://localhost:8081/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://a.task3_2.vis.mc.hagenberg.fh.at/", "HelloWorldService");
    ...
    public IHelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://a.task3_2.vis.mc.hagenberg.fh.at/", "HelloWorldPort"), IHelloWorld.class);
    }
    ...
    public IHelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://a.task3_2.vis.mc.hagenberg.fh.at/", "HelloWorldPort"), IHelloWorld.class, features);
    }
